...
class IndexAction extends AdminbaseAction
{
	...
	public function main() {
        ...
        $productinfo = M('Product')->field("title")->limit(0,10)->select();
        $articleinfo = M('Article')->field("title")->limit(0,10)->select();
        $messageinfo = M('Message')->field("com")->limit(0,10)->select();
        $slideinfo = M('Slide_data')->field("pic")->limit(0,10)->where('fid=1')->select();
